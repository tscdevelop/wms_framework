...
import InBoundToolingAPI from "api/InBoundToolingAPI"; // Import API
import html2canvas from "html2canvas";
import jsPDF from "jspdf";
import { QRCodeCanvas } from "qrcode.react"; // Import QRCodeCanvas
import ButtonComponent from "./ButtonComponent";
const PrintBarCodeToolingModal = ({ open, onClose, inbtl_id }) => {
  ...
  const qrData = labelData
    ? JSON.stringify({
        code: labelData.inbtl_code || "-",
        name: labelData.tlifm_name || "-",
      ...
      >
        ...
        {!isPrinting && (
          <Box mt={3} display="flex" justifyContent="center">
            <ButtonComponent type="print" onClick={generatePDF} sx={{ width: "100px", textAlign: "center" }}/>
...
export default PrintBarCodeToolingModal;
