...
import InBoundRawAPI from "api/InBoundRawAPI"; // Import API
import html2canvas from "html2canvas";
import jsPDF from "jspdf";
import { QRCodeCanvas } from "qrcode.react"; // เปลี่ยนเป็นการ import ชื่อ QRCodeCanvas
import ButtonComponent from "./ButtonComponent";
const PrintBarCodeRmModal = ({ open, onClose, inbrm_id }) => {
  ...
  const qrData = labelData
    ? JSON.stringify({
        code: labelData.inbrm_code || "-",
        name: labelData.rmifm_name || "-",
...
export default PrintBarCodeRmModal;
