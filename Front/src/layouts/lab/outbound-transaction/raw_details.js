...
// eslint-disable-next-line no-unused-vars
 ...
 const navigate = useNavigate(); 
  const handleReturn = () =>{
    ...
    navigate("/outbtransaction/outbraw");
  };
      ...
      <MDBox p={2}>
        <MDBox mt={2} ml={5}>
          <MDTypography variant="h3" color="inherit" fontWeight="bold">
            Outbound Transaction / เบิก Raw Material / รายละเอียด
          </MDTypography>
        </MDBox>
                    ...
                    <MDBox p={5}>
                        <Card>
                            <TableComponent
                                ...
                                { field: "inbrm_quantity", label: "จำนวนในคลัง", width: "20%" },
                                { field: "outbrmitm_quantity", label: "จำนวนเบิกเเล้ว", width: "15%" },
...
export default OutbTranRawDetails;
